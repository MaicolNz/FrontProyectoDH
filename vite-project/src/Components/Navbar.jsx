    ...
    <nav>
      <div className='background-nav'>
        ...
        >
          ...
          )} <label style={{ color: 'white', marginRight: '10px', marginLeft: '10px'  }}>
            Fecha de inicio:
            <input
              type="date"
              style={{
          ...
          <label style={{ color: 'white', marginRight: '10px'  }}>
            ...
            />
          </label><button style={{borderRadius: '10px', height: '40px', width: '150px', backgroundColor: 'grey', color: 'white' }}>BUSCAR</button></div>
