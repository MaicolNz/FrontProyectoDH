    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (editProductId) {
                ...
                response = await fetch(`https://backendproyectodh-production.up.railway.app/api/admin/instrumento/modificarInstrumento/${editProductId}`, {
                    method: 'PUT',
                    headers: {
                ...
                response = await fetch(`https://backendproyectodh-production.up.railway.app/api/admin/instrumento/registrarInstrumento`, {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json',
